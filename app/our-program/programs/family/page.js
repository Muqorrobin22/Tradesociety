...
export default function FamilyPage() {
    ...
    return (
        <main className={clsx("mt-10")}>
            ...
            {/* Hero Section */}
            <section
                className={clsx("relative bg-linear-gradient-program-family desktop:h-[400px] mobile:h-[600px] desktop:px-[72px] rounded-[32px] flex desktop:items-center mobile:mt-[120px] desktop:mt-[120px] desktop:mx-[120px] mobile:p-8 desktop:m-0 overflow-hidden ")}>
