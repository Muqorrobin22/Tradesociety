...
export default function FAQCard({onClick, activeIndex, theAnswer, theQuestion, height = "h-[200px]"}) {
    ...
    return (
        <div
            className={clsx(" border-[1px] border-[#E3EDFB] rounded-[32px] p-8 bg-white flex flex-col  transition-all duration-500  ", showFaq === activeIndex ? `${height}` : "h-auto")}>
