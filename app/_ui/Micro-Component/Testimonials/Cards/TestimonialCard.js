...
export default function TestimonialCard({ name, comments, job, bg_color, bg_cards = "bg-white" }) {
    return <div className={clsx(`relative rounded-[32px]  p-4 desktop:min-w-[270px] desktop:max-w-[270px] mobile:min-w-[260px] mobile:max-w-[260px] ${bg_cards} desktop:max-h-[140px] mobile:min-h-[140px] mobile:max-h-[141px] desktop:min-h-[138px] shadow-md `)}>
