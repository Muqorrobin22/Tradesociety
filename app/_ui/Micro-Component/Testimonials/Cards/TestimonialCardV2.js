...
export default function TestimonialCardV2({ name, comments, job, bg_color, bg_cards = "bg-white" }) {
    return <div className={clsx(`relative rounded-[32px]  p-4 desktop:min-w-[270px] desktop:max-w-[270px]  mobile:min-w-[270px] mobile:max-w-[270px] ${bg_cards} desktop:max-h-[140px] desktop:min-h-[138px] mobile:min-h-[138px] mobile:max-h-[140px] `)}>
